...
class ChefTest < ActiveSupport::TestCase
    ...
    test "chef should be valid" do
      ...
      test "chef should be too long" do
          @chef.chefname = "a" * 41
          assert_not @chef.valid?
     end
     
    test "chef should be too short" do
          @chef.chefname = "aa"
          assert_not @chef.valid?
     end
    ...
    test "email address should be unique" do    
     ...
     test "email validation should be accept valid address" do
        valid_addresses = %w[user@eee.com R_TDD-DS@eee.hello.org user@gmail.com first.last@eem.au laura+joe@mank.cm]
